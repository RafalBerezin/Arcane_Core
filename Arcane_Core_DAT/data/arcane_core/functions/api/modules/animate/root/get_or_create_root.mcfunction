...
#
# @api
# @context owner of animation root
#
# @input
#   macro
#       run: `string`
...
$execute if function arcane_core:api/entity/link/find_targets/cache_owner as @e[type=minecraft:text_display] if function arcane_core:internal/modules/animate/root/filter_root at @s run return run $(run)
