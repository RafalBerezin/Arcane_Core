#> Called by arcane_core:internal/utils/hooks/player/die_and_respawn
...
execute if score #ac.temp ac.flag matches 1 run function arcane_core:internal/utils/hooks/player/die_and_respawn/position_death/prepare_data
