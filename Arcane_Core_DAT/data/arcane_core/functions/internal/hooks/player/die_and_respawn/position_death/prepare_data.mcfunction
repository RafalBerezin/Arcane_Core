#> Called by arcane_core:internal/hooks/player/die_and_respawn/die
...
function arcane_core:internal/hooks/player/die_and_respawn/position_death/position with storage arcane_core:macros root.positioning
